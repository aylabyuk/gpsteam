import { SELECTED_CONTACT, SELECTED_STAFFS, REMOVE_SELECTED_STAFF, RESET_CONTACT_ID, RESET_SELECTED_STAFFS, CLICKED_SITE, TOGGLE_LOGSHEET_SUBMITTING,
	TOGGLE_SEARCH_LOGSHEET, REVIEW_LOGSHEET, LOGSHEET_MODE, TOGGLE_SIDENAV, SET_SEARCH_LOGSHEET } from './types'
...
export function setSearchLogsheets(data) {
	return function(dispatch) {
		dispatch({
			type: SET_SEARCH_LOGSHEET,
			payload: data
		})
	}
}